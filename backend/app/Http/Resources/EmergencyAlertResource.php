...
class EmergencyAlertResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'compatibility_mode' => $this->compatibility_mode ?? 'compatible',
            'level' => $this->level,
            'units_needed' => $this->units_needed,
            'status' => $this->status,
            'active' => $this->status === 'active',
            'accepting_commitments' => $this->acceptsNewCommitments(),
            'message' => $this->message,
            'expires_at' => $this->expires_at?->toIso8601String(),
            'broadcast_stopped_at' => $this->broadcast_stopped_at?->toIso8601String(),
